...
def main(tx, ty, test_x, test_y, file_t, mapping):
	...
	with tf.Session() as sess:
		...
		pred.index+=1
		pred.to_csv("cnnRaw_epoch30000.csv", sep=',', header=['Label'], index=True, index_label='ID', encoding='utf-8')
...
if __name__ == '__main__':
	#Loading data
	file_x = "../data/train_x.csv"
	file_y = "../data/train_y.csv"
	file_t = "../data/test_x.csv"
